/* Legacy prototype Azure Function retained as reference infrastructure for the repo.
 * The active Genie local demo currently runs through the declarative agent package
 * and the mock API entry point.
 */
